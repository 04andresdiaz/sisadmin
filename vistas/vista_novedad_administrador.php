...
<body>
	<div class="menu-lateral">
		...
		<div class="contenedor-items">
			<ul class='lista'>
				...
				<a href="vista_novedad_administrador.php"><li class="items-seleccionado"><img src="../imagenes/novedades.png" alt="Imagen de novedades"><p>Novedades</p></li></a>
	...
	<div class="contenido-principal">
		...
		<div class="contenido">
			<iframe src="../consultas/consulta_novedades_administrador.php" frameborder="0"></iframe>
		</div>
	</div>
</body>
</html>
